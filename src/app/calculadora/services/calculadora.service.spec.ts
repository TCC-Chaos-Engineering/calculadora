...
describe('CalculadoraService', () => {
  ...
  it('Deve garantir que 1 + 1 é igual a 2',
    inject([CalculadoraService], (service: CalculadoraService) => {
      const soma = service.calcular(1, 1, CalculadoraService.SOMA);
  ...
  it('Deve garantir que 3 - 2 é igual a 1',
    inject([CalculadoraService], (service: CalculadoraService) => {
      const subtracao = service.calcular(3, 2, CalculadoraService.SUBTRACAO);
  ...
  it('Deve garantir que 2 * 2 é igual a 4',
    inject([CalculadoraService], (service: CalculadoraService) => {
      const multiplicacao = service.calcular(2, 2, CalculadoraService.MULTIPLICACAO);
  ...
  it('Deve retornar 0 para operação inválida',
    inject([CalculadoraService], (service: CalculadoraService) => {
      const multiplicacao = service.calcular(2, 2, '%');
